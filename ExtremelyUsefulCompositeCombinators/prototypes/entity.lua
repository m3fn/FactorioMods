local function generate_arithmetic_combinator2(name, combinator)
...
generate_constant_combinator
  ...
  generate_arithmetic_combinator2("simple-delay-combinator",
  {
  ...
  generate_arithmetic_combinator2("inclusive-filter-combinator",
  {
    type = "arithmetic-combinator",
